...
# Data =================================================================================================
wiot <- readRDS(here("data/wiot_nozero.rds"))
...
parameters_nozero <- (list("alpha" = alpha,
                            "beta" = beta,
                            "iota" = iota,
                            "gamma_njk" = gamma_njk,
                            "gamma_nj" = gamma_nj, 
...
saveRDS(variables_nozero, here("data/variables_nozero"))
saveRDS(parameters_nozero,here("data/parameters_nozero"))
